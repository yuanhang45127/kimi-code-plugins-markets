...
| 📊 **Kimi Quota** | Query Kimi Code weekly quota, 5h rolling limit, and Extra Usage balance via MCP |
...
│   └── kimi-quota/                # Quota query (MCP tool)
├── dist/                          # Plugin zip packages (generated by scripts/release.sh)
